                ...
                <div class="bg-white rounded-3xl shadow-sm border border-slate-100 p-6">
                    <div class="flex items-center justify-between mb-5">
                        ...
                        <div id="toolbar-edit" class="hidden flex items-center gap-2">
                            ...
                            <button onclick="saveProfile()" class="bg-amber-600 text-white hover:bg-amber-500 font-bold px-4 py-2 rounded-xl text-xs transition shadow-lg shadow-amber-500/20 active:scale-95">
                                Save Changes
                            </button>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="password" name="current_password" id="current_password" required
                                       class="w-full bg-slate-50 border border-slate-200 text-slate-800 rounded-xl px-4 py-3 pr-12 focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-amber-400 text-sm">
                                <button type="button" onclick="togglePasswordVisibility('current_password', 'eye-current')" 
                                        class="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-amber-500 transition p-1">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="password" name="new_password" id="new_password" required minlength="8" placeholder="Min. 8 characters"
                                               class="w-full bg-slate-50 border border-slate-200 text-slate-800 placeholder-slate-400 rounded-xl px-4 py-3 pr-12 focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-amber-400 text-sm">
